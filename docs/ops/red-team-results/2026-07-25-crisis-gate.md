...
RUN  v2.1.9 C:/Patient centered
 ...
 ✓ src/domain/crisis-red-flags.test.ts (187 tests) 54ms
 ✓ src/ai/voice-gate-corpus.test.ts (2 tests) 44ms
 ...
 Test Files  6 passed (6)
   ...
   Start at  20:02:22
   Duration  2.17s (transform 819ms, setup 873ms, collect 1.59s, tests 232ms, environment 4.30s, prepare 706ms)
```
