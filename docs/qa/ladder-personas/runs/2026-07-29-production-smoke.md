...
| L03 resource order | `https://patient-centered.vercel.app/ladder` | 2026-07-30 7:39:54.235–7:40:04.708 AM EDT (`2026-07-30T11:39:54.235Z`–`2026-07-30T11:40:04.708Z`; `America/New_York`), from the retained final L03 context timestamps | `C:\Patient centered\test-results\ladder-personas\2026-07-29\production-smoke-evidence.json`<br>`C:\Patient centered\test-results\ladder-personas\2026-07-29\production-L03\initial-booking.png` | Confirmed defect: `kde_dispute_resolution` and `idea_school_discipline` lead; 18/20 (90%), Green. | The identical ten-resource order reproduced; the rest of the journey completed. | **Non-reproducing** — known local defect, not deployment drift. |
