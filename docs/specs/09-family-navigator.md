...
**Status:** implemented and live — `/ladder` (rebranded from Family Navigator by plan 14). Verified 2026-08-04.
...
>
> **2026-07-25 — waitlist companion:** spec 13 (waitlist companion) extends the wait itself: journal, packet, steps/clocks, check-in + pulse, guides, earlier-visit list. Spec: `docs/specs/13-ladder-waitlist-companion.md`; plan: `docs/plans/15-ladder-waitlist-companion.md`. The impact dashboard stays deferred, but its engagement-event substrate lands here.
