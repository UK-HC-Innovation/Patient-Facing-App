...
export const foodLensStrings: Record<Language, Record<FoodLensStringKey, string>> = {
  en: {
    ...
    moreAboutThisFood: "More about this food",
    ...
    weekOpenFood: "Open 1 good choice",
    ...
    compassPageTitle: "1 good choice",
    compassPageDescription: "Point at a food. Say the restaurant or size if you know it.",
    ...
    compassRoleYou: "You",
    compassAssistantName: "1 good choice",
    ...
    verdictModerate: "Fine now and then.",
    verdictMinimize: "A lot of calories for the nutrition you get.",
    verdictMinimizeLight: "Little nutrition for what it is.",
  ...
  es: {
    ...
    moreAboutThisFood: "Más sobre esta comida",
    ...
    weekOpenFood: "Abrir 1 good choice",
    ...
    compassKcalPer100g: "{calories} kcal / 100 g",
    compassPageTitle: "1 good choice",
    compassPageDescription: "Apunta a una comida. Di el restaurante o el tamaño si los sabes.",
    ...
    verdictModerate: "Está bien de vez en cuando.",
    verdictMinimize: "Muchas calorías para la nutrición que aporta.",
    verdictMinimizeLight: "Poca nutrición para lo que es.",
